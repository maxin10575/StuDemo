...
//    private final static String TITLE = "[B站 | 顾咕咕了] https://jianwoo.cn";
    private final static String TITLE = "by maxin";
...
//            System.out.println("<<"+note.getStartTime());
    ...
    public static void main(String[] args)
    {
        List<NoteBO> noteList_n = ReadXmlAsNoteUtil.getInstance()
                .readAsNote("/Users/maxin/Documents/GitHub/StuDemo/MyMusic/src/main/resources/notes/大鱼_主奏.xml", NoteBO.Mode.MAIN);
