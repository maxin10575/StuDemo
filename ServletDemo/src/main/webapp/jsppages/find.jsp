<%@page pageEncoding="utf-8" import="java.util.*,entity.*,web.*"%>
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%@taglib uri="/mx-tags" prefix="s"%>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<body>
	...
	<!-- 4.自定义标签 -->
	<p>
		<s:sysdate format="yyyy年MM月dd日 HH:mm:ss" />
	</p>

	
	<h1>EL</h1>
	<!-- 1.获取bean的属性 -->
	<!-- 相当于requset.getAttribute("stu").getName() -->
	<p>姓名:${stu.name }</p>
	<p>年龄：${stu["age"] }</p>
	<!-- requset.getAttribute("stu").getCourse().getid() -->
	<p>课程：${stu.course.id }</p>
	<!-- EL默认从4个内置对象中取值，并且它是依次取值，这4个对象叫取值范围：
