...
public class TestBolt extends BaseRichBolt{
    ...
    */
	...
	public void prepare(Map map, TopologyContext arg1, OutputCollector collector) {
		System.out.println("TestBolt1-prepare:"+map.get("test"));
	...
	public void execute(Tuple tuple) {
	    ...
	    System.out.println("TestBolt1-开始分割单词:"+msg);
        String[] words = msg.toLowerCase().split(" ");
        for (String word : words) {
			System.out.println("TestBolt1-向下一个bolt发射数据"+new Values(word));
	...
	@Override
	public void cleanup() {
		System.out.println("TestBolt1的资源释放");
	}
}
