...
/**
 * @program: KafkaTest
 * @description: 生产消息到 指定分区- 自定义序列化
 * @author: maxin
 * @create: 2020-03-11 14:11
 * @Modified By:
 * @Version: 1.0
 **/
...
public class ProducerPartitions {
    ...
    public static void main(String[] args) {
        ...
        // 自定义序列化value的值
        props.put("value.serializer", "mx.CustomSerializer.UserSerializer");
        ...
        //指定序列化生产的消息
        ProducerRecord<String, User> userRecord = new ProducerRecord<String, User>(topic, user);
